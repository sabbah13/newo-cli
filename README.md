...
- 🆕 **V2 skill creation on push** (v3.7.3) - adding a skill inline to a `newo_v2` `{FlowIdn}.yaml` and pushing now creates it on the platform (previously only updates of existing skills worked)
